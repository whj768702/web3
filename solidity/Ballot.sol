...
contract Ballot {
    ...
    constructor(bytes32[] propsalNames) public {
    ...
    function giveRightToVote(addree voter) public {
    ...
    function vote(unit proposal) public {
        Voter storage sender = voters[msg.sender];
    ...
    function winningProposal() public view returns (unit winningProposal_) {
